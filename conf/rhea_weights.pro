% baseline boost
weight(2.0, [predicate_id='owl:equivalentClass', subject_category=molecular_function, object_category='RHEA:Reaction']).

% GO curated xref to RHEA
weight(2.0, [predicate_id='owl:equivalentClass', subject_match_field='oio:hasDbXref', object_match_field='dc:identifier']).

% shared xref
weight(0.5, [predicate_id='owl:equivalentClass', subject_match_field='oio:hasDbXref', object_match_field='oio:hasDbXref']).

weight(1, [predicate_id='owl:equivalentClass', match_category='unique']).
...
weight(-4.0, [predicate_id='owl:equivalentClass', match_type=['Lexical','Flattening']]).
weight(-3.0, [predicate_id='owl:equivalentClass', match_type=['Lexical','Stemming']]).
weight(-2.5, [predicate_id='owl:equivalentClass', match_type=['Lexical']]).
